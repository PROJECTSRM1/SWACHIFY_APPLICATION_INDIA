...
const RetailInStoreContent: React.FC<ContentComponentProps> = () => (
  ...
  >
    ...
    <Button type="primary" htmlType="submit" className='swc-bs-completesale_btn'>
      Complete Sale
    </Button>
  </Form>
);
...
const RetailInventoryContent: React.FC<ContentComponentProps> = () => (
  ...
  >
    ...
    <Button className="swc-bs-button-spacer-right">Fetch Purchase History</Button>
  </Form>
);
...
const WholesaleBulkContent: React.FC<ContentComponentProps> = () => (
  ...
  >
    ...
    <Button className="swc-bs-completesale_btn " htmlType="submit">
      Submit Bulk Order
    </Button>
  </Form>
);
...
const WholesaleStockContent: React.FC<ContentComponentProps> = () => (
  ...
  >
    ...
    <Button className='swc-bs-completesale_btn' type="primary" htmlType="submit">
...
const renderSubservicesModalContent = () => (
  ...
  return (
<div className="swc-bs-theme swc-bs-app-container">
