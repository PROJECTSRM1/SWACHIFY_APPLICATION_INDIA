...
//   { key: 'dashboard', label: 'Dashboard', icon: <DashboardOutlined /> },
//   { key: 'tickets', label: 'All Tickets', icon: <FieldTimeOutlined /> },
//   { key: 'users', label: 'Employees', icon: <UserOutlined /> },
//   // { key: 'freelancers', label: 'Freelancers', icon: <TeamOutlined /> },
//   // { key: 'vendors', label: 'Vendors', icon: <ShopOutlined /> },
// ]

// export const dashboardStats = [
//   { key: 'users', label: 'Total Cars', value: 1247, },
//   { key: 'freelancers', label: 'Cars Out', value: 342,  },
//   { key: 'vendors', label: 'Cars In', value: 89,  },
//   { key: 'active', label: ' Total Employees / Drivers', value: 156, },
//   { key: 'completed', label: 'Today’s Bookings', value: 2341,  },
//   { key: 'pending', label: 'Completed Bookings', value: 67, },
//    { key: 'completed', label: ' Revenue', value: 2341, },
//   { key: 'pending', label: 'Issues', value: 67,  },
// ]
...
// src/vendor/shared/data.ts
export const statsMock = [
  { key: 'totalCars', label: 'Total Cars', value: 24, delta: 2 },
  { key: 'carsOut', label: 'Cars Out', value: 18, delta: 3 },
  { key: 'carsIn', label: 'Cars In', value: 6, delta: -3 },
  { key: 'drivers', label: 'Total Drivers', value: 15, delta: 1 },
  { key: 'today', label: "Today's Bookings", value: 8, delta: 2 },
  { key: 'pending', label: 'Pending Requests', value: 5, delta: 0 },
];
...
export const fleetPie = [
  { name: 'Cars Out', value: 18 },
  { name: 'Cars In', value: 6 },
];
