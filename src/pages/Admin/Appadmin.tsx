...
function getTabFromPath(pathname: string): TabKey {
  ...
  if (pathname.includes("/adminshell/services")) return "services";
  return "dashboard";
}
        ...
        <main className="sw-ad-content">
          <Routes>
            ...
            <Route
              path="users"
              element={
                <UsersPage users={users} onStatusToggle={handleUserStatusToggle} tickets={[]} />
              }
            />
            ...
            <Route
              ...
              element={
                <VendorsPage
                  vendors={vendors}
                  onStatusToggle={handleVendorStatusToggle}
                />
              }
            />
