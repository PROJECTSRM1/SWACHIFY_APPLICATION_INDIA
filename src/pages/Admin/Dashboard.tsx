...
const DashboardPage = ({ tickets }: Props) => {
  ...
  const handleCardClick = (key: string) => {
    switch (key) {
      case 'users':
        navigate('/adminshell/users')
        break
      case 'freelancers':
        navigate('/adminshell/freelancers')
        break
      case 'vendors':
        navigate('/adminshell/vendors')
        break
      case 'active':
        navigate('/adminshell/tickets?status=active')
        break
      case 'completed':
        navigate('/adminshell/tickets?status=completed')
        break
      case 'pending':
        navigate('/adminshell/tickets?status=pending')
        break
      default:
        break
    }
    ...
    <div className="sw-ad-page-card">
      <section className="sw-ad-stats-grid">
        {dashboardStats.map((stat) => (
          <Card
            key={stat.key}
            className="sw-ad-stat-card sw-ad-clickable-card"
            bordered={false}
