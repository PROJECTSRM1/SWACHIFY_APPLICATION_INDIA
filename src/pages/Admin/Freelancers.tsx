          ...
          columns={[
            ...
            },
            {
              ...
              render: (skills: string[], record: Freelancer) => {
                ...
                return (
                  <div className="sw-ad-skills-cell-vertical">
                    <div className="sw-ad-skills-row">
                      {visibleSkills.map((skill) => {
                        const isTruncated = skill.length > maxSkillLength
                        const displayText = truncateSkill(skill)
                      ...
                      {hasMore && <span className="sw-ad-skills-ellipsis">...</span>}
                    </div>
                    {hasMore && (
                      <Button
                        type="link"
                        size="small"
                        onClick={() => setViewSkillsFreelancer(record)}
                        className="sw-ad-view-more-btn-vertical"
                      >
                        View More
                      </Button>
                    )}
      ...
      >
        {viewFreelancer && (
          <>
            ...
            <div className="sw-ad-skills-container-modal">
              {viewFreelancer.skills.map((skill) => (
                <Tag key={skill} bordered={false} className="sw-ad-skill-tag-styled">
                  {skill}
                </Tag>
              ))}
            </div>
