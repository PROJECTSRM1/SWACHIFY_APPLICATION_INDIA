...
export const initialTickets: Ticket[] = [
  { id: 'TKT001', customer: 'Rajesh Kumar', service: 'Cleaning - Deep Cleaning', date: '2025-11-28', serviceStatus: 'pending', assignedTo: '', priority: 'high', paymentStatus: 'pending', location: 'Mumbai' },
  { id: 'TKT002', customer: 'Rahul Verma', service: 'Construction Materials - Cement', date: '2025-11-27', serviceStatus: 'accepted', assignedTo: 'ABC Suppliers (Vendor)', priority: 'medium', paymentStatus: 'paid', location: 'Delhi' },
  { id: 'TKT003', customer: 'Vikram Singh', service: 'Home Services - Plumbing', date: '2025-11-25', serviceStatus: 'completed', assignedTo: 'Vikram Reddy (Freelancer)', priority: 'low', paymentStatus: 'paid', location: 'Bengaluru' },
  { id: 'TKT004', customer: 'Priya Sharma', service: 'Home Services - Plumbing', date: '2025-11-29', serviceStatus: 'in-progress', assignedTo: 'Suresh Gowda (Freelancer)', priority: 'high', paymentStatus: 'pending', location: 'Pune' },
  { id: 'TKT005', customer: 'Sneha Rao', service: 'Cleaning - Sanitization', date: '2025-11-30', serviceStatus: 'pending', assignedTo: '', priority: 'medium', paymentStatus: 'failed', location: 'Hyderabad' },
  { id: 'TKT006', customer: 'Amit Patel', service: 'Construction Materials - Steel', date: '2025-11-26', serviceStatus: 'accepted', assignedTo: 'XYZ Materials (Vendor)', priority: 'high', paymentStatus: 'paid', location: 'Ahmedabad' },
]
...
export const initialFreelancers: Freelancer[] = [
  ...
  { id: 'FRL004', name: 'Amit Shah', email: 'amit.shah@email.com', skills: ['Electrical', 'Wiring', 'Solar Panels', 'Inverter Installation', 'Appliance Repair'], completed: 41, rating: 4.5, status: 'approved', age: 42, city: 'Mumbai', aadhaar: '880920866676', pan: 'KZTPS2753N' },
  { id: 'FRL005', name: 'Pooja Joshi', email: 'pooja.joshi@email.com', skills: ['HVAC', 'AC Repair', 'Ventilation', 'Refrigeration', 'Duct Cleaning'], completed: 36, rating: 4.6, status: 'approved', age: 31, city: 'Mumbai', aadhaar: '854722745965', pan: 'NZDFS4818J' },
  // Extra Mumbai Cleaning to test limit
  { id: 'FRL005_1', name: 'Ravi Verma (Demo)', email: 'ravi.demo@email.com', skills: ['Cleaning', 'Deep Cleaning'], completed: 36, rating: 4.9, status: 'approved', age: 31, city: 'Mumbai', aadhaar: '854722745999', pan: 'NZDFS4899J' },
  { id: 'FRL005_2', name: 'Sunita Sharma (Demo)', email: 'sunita.demo@email.com', skills: ['Cleaning', 'Sanitization'], completed: 40, rating: 4.5, status: 'approved', age: 29, city: 'Mumbai', aadhaar: '999722745965', pan: 'ZZDFS4888J' },
  { id: 'FRL005_3', name: 'Amit Kumar (Demo)', email: 'amit.demo@email.com', skills: ['Cleaning', 'Floor Polishing'], completed: 22, rating: 4.2, status: 'approved', age: 25, city: 'Mumbai', aadhaar: '888722745965', pan: 'AAAFS4877J' },
  { id: 'FRL005_4', name: 'Priya Singh (Demo)', email: 'priya.demo@email.com', skills: ['Cleaning'], completed: 15, rating: 4.7, status: 'approved', age: 24, city: 'Mumbai', aadhaar: '777722745965', pan: 'BBBFS4866J' },
  { id: 'FRL005_5', name: 'Rahul Roy (Demo)', email: 'rahul.demo@email.com', skills: ['Cleaning', 'Home Services'], completed: 55, rating: 4.8, status: 'approved', age: 35, city: 'Mumbai', aadhaar: '666722745965', pan: 'CCCFS4855J' },
  ...
  { id: 'FRL013', name: 'Lakshmi Reddy', email: 'lakshmi.reddy@email.com', skills: ['Cleaning', 'Deep Cleaning', 'Sanitization', 'Carpet Cleaning', 'Floor Polishing'], completed: 62, rating: 4.9, status: 'approved', age: 35, city: 'Bengaluru', aadhaar: '274604575291', pan: 'RSPIR0354S' },
  { id: 'FRL014', name: 'Suresh Gowda', email: 'suresh.gowda@email.com', skills: ['HVAC', 'Refrigeration', 'AC Repair', 'Ventilation', 'Duct Cleaning'], completed: 47, rating: 4.6, status: 'approved', age: 41, city: 'Bengaluru', aadhaar: '712130512507', pan: 'HRSOR7364H' },
  // Bengaluru Plumbers to test limit
  { id: 'FRL012_1', name: 'Rohan Kumar (Demo)', email: 'rohan.k@email.com', skills: ['Plumbing', 'Drainage'], completed: 33, rating: 4.6, status: 'approved', age: 30, city: 'Bengaluru', aadhaar: '804374279599', pan: 'HVBND4099V' },
  { id: 'FRL012_2', name: 'Amit Singh (Demo)', email: 'amit.s@email.com', skills: ['Plumbing', 'Pipe Fitting'], completed: 44, rating: 4.9, status: 'approved', age: 35, city: 'Bengaluru', aadhaar: '804374279588', pan: 'HVBND4088V' },
  { id: 'FRL012_3', name: 'Vijay Reddy (Demo)', email: 'vijay.r@email.com', skills: ['Plumbing', 'Water Heater'], completed: 25, rating: 4.5, status: 'approved', age: 28, city: 'Bengaluru', aadhaar: '804374279577', pan: 'HVBND4077V' },
  { id: 'FRL012_4', name: 'Kiran Rao (Demo)', email: 'kiran.r@email.com', skills: ['Plumbing'], completed: 18, rating: 4.7, status: 'approved', age: 26, city: 'Bengaluru', aadhaar: '804374279566', pan: 'HVBND4066V' },
  { id: 'FRL012_5', name: 'Sanjay Gowda (Demo)', email: 'sanjay.g@email.com', skills: ['Plumbing', 'Bathroom Fitting'], completed: 50, rating: 4.8, status: 'approved', age: 42, city: 'Bengaluru', aadhaar: '804374279555', pan: 'HVBND4055V' },
  { id: 'FRL015', name: 'Divya Murthy', email: 'divya.murthy@email.com', skills: ['Painting', 'Wallpaper', 'Texture', 'Interior Design', 'Color Consultation'], completed: 33, rating: 4.7, status: 'approved', age: 30, city: 'Bengaluru', aadhaar: '535976818178', pan: 'FNOYQ3521Y' },

  // Hyderabad - 5 members
  { id: 'FRL016', name: 'Priya Sharma', email: 'priya.sharma@email.com', skills: ['Cleaning', 'Home Services', 'Deep Cleaning', 'Sanitization', 'Floor Polishing'], completed: 67, rating: 4.9, status: 'approved', age: 41, city: 'Hyderabad', aadhaar: '921685882751', pan: 'OURAV2916J' },
  // Hyderabad Cleaning to test limit
  { id: 'FRL016_1', name: 'Sneha Reddy (Demo)', email: 'sneha.r@email.com', skills: ['Cleaning', 'Sanitization'], completed: 45, rating: 4.8, status: 'approved', age: 29, city: 'Hyderabad', aadhaar: '921685882799', pan: 'OURAV2999J' },
  { id: 'FRL016_2', name: 'Anjali Rao (Demo)', email: 'anjali.r@email.com', skills: ['Cleaning'], completed: 30, rating: 4.6, status: 'approved', age: 26, city: 'Hyderabad', aadhaar: '921685882788', pan: 'OURAV2988J' },
  { id: 'FRL016_3', name: 'Kavita Singh (Demo)', email: 'kavita.s@email.com', skills: ['Cleaning', 'Deep Cleaning'], completed: 55, rating: 4.9, status: 'approved', age: 34, city: 'Hyderabad', aadhaar: '921685882777', pan: 'OURAV2977J' },
  { id: 'FRL016_4', name: 'Ritu Patel (Demo)', email: 'ritu.p@email.com', skills: ['Cleaning', 'Floor Polishing'], completed: 22, rating: 4.5, status: 'approved', age: 25, city: 'Hyderabad', aadhaar: '921685882766', pan: 'OURAV2966J' },
  { id: 'FRL016_5', name: 'Megha Gupta (Demo)', email: 'megha.g@email.com', skills: ['Cleaning'], completed: 38, rating: 4.7, status: 'approved', age: 31, city: 'Hyderabad', aadhaar: '921685882755', pan: 'OURAV2955J' },
  { id: 'FRL017', name: 'Venkat Reddy', email: 'venkat.reddy@email.com', skills: ['Electrical', 'Wiring', 'Solar', 'Inverter Installation', 'Appliance Repair'], completed: 51, rating: 4.7, status: 'approved', age: 37, city: 'Hyderabad', aadhaar: '274093366623', pan: 'DSUTC8233V' },
  { id: 'FRL018', name: 'Shalini Rao', email: 'shalini.rao@email.com', skills: ['Interior Design', 'Decor', 'Furniture', 'Painting', 'Wallpaper'], completed: 39, rating: 4.8, status: 'approved', age: 32, city: 'Hyderabad', aadhaar: '500369719892', pan: 'XRDGB7327N' },
  { id: 'FRL019', name: 'Ravi Kumar', email: 'ravi.kumar@email.com', skills: ['Plumbing', 'Pipe Fitting', 'Drainage', 'Water Heater', 'Bathroom Fitting'], completed: 44, rating: 4.6, status: 'approved', age: 39, city: 'Hyderabad', aadhaar: '002620604529', pan: 'LHXAH5974L' },
  { id: 'FRL020', name: 'Kavitha Naidu', email: 'kavitha.naidu@email.com', skills: ['Carpentry', 'Woodwork', 'Furniture', 'Cabinet Making', 'Door Fitting'], completed: 35, rating: 4.7, status: 'approved', age: 34, city: 'Hyderabad', aadhaar: '053160431342', pan: 'LUJCT3138S' },
  ...
  { id: 'FRL039', name: 'Aditi Deshmukh', email: 'aditi.deshmukh@email.com', skills: ['Interior Design', 'Furniture', 'Decor', 'Painting', 'Wallpaper'], completed: 41, rating: 4.9, status: 'approved', age: 31, city: 'Pune', aadhaar: '299132691640', pan: 'AVAAI2787R' },
  { id: 'FRL040', name: 'Nikhil Patil', email: 'nikhil.patil@email.com', skills: ['Electrical', 'Solar', 'Wiring', 'Inverter Installation', 'Appliance Repair'], completed: 38, rating: 4.6, status: 'approved', age: 36, city: 'Pune', aadhaar: '187546311551', pan: 'VEHKX9937L' },
  // Pune Plumbing to test limit
  { id: 'FRL038_1', name: 'Suresh Joshi (Demo)', email: 'suresh.j@email.com', skills: ['Plumbing', 'Pipe Fitting'], completed: 42, rating: 4.7, status: 'approved', age: 35, city: 'Pune', aadhaar: '155900424599', pan: 'XBNZI5899I' },
  { id: 'FRL038_2', name: 'Ganesh Kulkarni (Demo)', email: 'ganesh.k@email.com', skills: ['Plumbing', 'Drainage'], completed: 38, rating: 4.6, status: 'approved', age: 32, city: 'Pune', aadhaar: '155900424588', pan: 'XBNZI5888I' },
  { id: 'FRL038_3', name: 'Rakesh Deshmukh (Demo)', email: 'rakesh.d@email.com', skills: ['Plumbing', 'Water Heater'], completed: 50, rating: 4.9, status: 'approved', age: 40, city: 'Pune', aadhaar: '155900424577', pan: 'XBNZI5877I' },
  { id: 'FRL038_4', name: 'Amit Patil (Demo)', email: 'amit.p@email.com', skills: ['Plumbing'], completed: 25, rating: 4.5, status: 'approved', age: 28, city: 'Pune', aadhaar: '155900424566', pan: 'XBNZI5866I' },
  { id: 'FRL038_5', name: 'Vikas Pawar (Demo)', email: 'vikas.p@email.com', skills: ['Plumbing', 'Bathroom Fitting'], completed: 30, rating: 4.8, status: 'approved', age: 31, city: 'Pune', aadhaar: '155900424555', pan: 'XBNZI5855I' },
